      ...
      <div class="input-container">
        <div class="column">
          ...
          <div class="conversion-box">
            ...
            />
            <select  class="selectbox" @change="changedFirstUnit()" v-model="selectedFirstUnit">
              <option
                class="option-box"
        ...
        <div class="column">
          ...
          <div class="conversion-box">
            ...
            />
            <select class="selectbox" @change="changedSecondUnit()" v-model="selectedSecondUnit">
              <option
                class="option-box"
                v-for="subUnit in subUnits"
                v-bind:key="subUnit"
...
.selectbox {
  ...
  background: url("data:image/svg+xml;base64,")
    white no-repeat calc(100% - 20px) !important;
